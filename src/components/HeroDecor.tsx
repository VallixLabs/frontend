    ...
    >
      ...
      >
        ...
        >
          ...
          <path d="M156 262 C 156 250, 186 250, 186 264 C 186 276, 171 274, 171 286" stroke="#485259" strokeWidth="2.8" />
          <path d="M171 296 L171 298" stroke="#485259" strokeWidth="3.4" />
          ...
          <path d="M596 40 L586 30 M596 40 L602 28" stroke="#485259" strokeWidth="2.4" />
        </svg>
      </Par>

      <Par par={0.5} parMax={300} float={18} floatSpeed={0.7} mouse={-70} rot={9} deco="small"
        style={{ position: 'absolute', right: '34%', top: '3%', color: '#8b9599' }}>
      ...
      <Par par={-0.62} parMax={320} float={26} floatSpeed={0.9} mouse={90} rot={-14} deco="small"
        style={{ position: 'absolute', right: '12%', top: '1%', color: '#777c7e' }}>
      ...
      <Par par={0.42} parMax={300} float={20} floatSpeed={0.55} mouse={-48} rot={7} deco="small"
        style={{ position: 'absolute', right: '8%', bottom: '2%', color: '#828d92' }}>
      ...
      <Par par={-0.44} parMax={300} float={16} floatSpeed={0.8} mouse={54} rot={-10} deco="small"
        style={{ position: 'absolute', left: '8%', bottom: '22%', color: '#8b9599' }}>
      ...
      <Par par={0.7} parMax={340} float={24} floatSpeed={1.05} mouse={-96} rot={16} deco="small"
        style={{ position: 'absolute', left: '56%', top: '10%', color: '#485259' }}>
      ...
      <Par par={-0.34} parMax={280} float={12} floatSpeed={0.62} mouse={44} rot={-6} deco="small"
        style={{ position: 'absolute', right: '3%', bottom: '12%', color: '#8b9599' }}>
      ...
      <Par par={0.3} parMax={260} float={15} floatSpeed={0.48} mouse={-34} rot={5} deco="small"
        style={{ position: 'absolute', left: '41%', top: '24%', color: '#8b9599' }}>
